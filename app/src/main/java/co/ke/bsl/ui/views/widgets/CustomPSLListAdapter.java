...
public class CustomPSLListAdapter extends BaseAdapter {
    Activity context;
    private ArrayList<SugarMillDetails> sugarMilllist;
    private LayoutInflater inflater = null;

    public CustomPSLListAdapter(Activity context, ArrayList<SugarMillDetails> sugarMilllist) {
    ...
    public View getView(int position, View contentview, ViewGroup parent) {
        ...
        textviewletter_of_comfort.setText("letter of comfort "+selecteditem.getLetter_of_comfort());
