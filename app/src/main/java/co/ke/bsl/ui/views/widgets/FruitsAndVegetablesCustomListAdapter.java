...
public class FruitsAndVegetablesCustomListAdapter extends BaseAdapter {
    Activity context;
    private ArrayList<FruitsAndVegetablesExporters> fruitsAndVegetablesExporterslist;
    private LayoutInflater inflater = null;

    public FruitsAndVegetablesCustomListAdapter(Activity context, ArrayList<FruitsAndVegetablesExporters> fruitsAndVegetablesExporterslist) {
        this.fruitsAndVegetablesExporterslist = fruitsAndVegetablesExporterslist;
        inflater = (LayoutInflater) context.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
    }

    @Override
    public int getCount() {
        return fruitsAndVegetablesExporterslist.size();
    }


    @Override
    public Object getItem(int position) {
        return fruitsAndVegetablesExporterslist.get(position);
    }
    ...
    public View getView(int position, View contentview, ViewGroup parent) {
        ...
        FruitsAndVegetablesExporters selecteditem = fruitsAndVegetablesExporterslist.get(position);
