...
public class TeaWarehouseManInspectionDataCollection implements Serializable {

    private LoginRequest loginRequest;

    private String serviceType="QueryTeaWarehouseMan";

    private String sentStatus;

    private  String AFA_TD_Warehousemanlicappl_ID;
    ...
    public TeaWarehouseManInspectionDataCollection(String document_number, String document_date, String name_of_applicant, String license_number) {
    ...
    public TeaWarehouseManInspectionDataCollection() {
    }
    ...
    public String getAFA_TD_Warehousemanlicappl_ID() {
        return AFA_TD_Warehousemanlicappl_ID;
    }

    public void setAFA_TD_Warehousemanlicappl_ID(String AFA_TD_Warehousemanlicappl_ID) {
        this.AFA_TD_Warehousemanlicappl_ID = AFA_TD_Warehousemanlicappl_ID;
    }
