...
public class CoffeeCommercialAgent implements java.io.Serializable {
    ...
    private  String afa_cd_Coffee_Commercial_mkt_Agent_id;
    ...
    public CoffeeCommercialAgent(String document_number, String document_date, String name_of_applicant, String licence_number) {
    ...
    public String getAfa_cd_Coffee_Commercial_mkt_Agent_id() {
        return afa_cd_Coffee_Commercial_mkt_Agent_id;
    }

    public void setAfa_cd_Coffee_Commercial_mkt_Agent_id(String afa_cd_Coffee_Commercial_mkt_Agent_id) {
        this.afa_cd_Coffee_Commercial_mkt_Agent_id = afa_cd_Coffee_Commercial_mkt_Agent_id;
    }
