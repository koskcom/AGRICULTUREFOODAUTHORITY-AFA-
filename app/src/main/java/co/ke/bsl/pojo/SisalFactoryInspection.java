...
public class SisalFactoryInspection implements Serializable {

    private LoginRequest loginRequest;

    private String serviceType = "QuerySisalFactoryInspection";

    private String sentStatus;

    private String AFA_Sisal_Factory_Inspection_ID;
    ...
    public SisalFactoryInspection() {
    }

    public SisalFactoryInspection(String documentNumber, String documentDate, String nameOfApplicant, String sisalSpinningExportNumber) {
    ...
    public String getAFA_Sisal_Factory_Inspection_ID() {
        return AFA_Sisal_Factory_Inspection_ID;
    }

    public void setAFA_Sisal_Factory_Inspection_ID(String AFA_Sisal_Factory_Inspection_ID) {
        this.AFA_Sisal_Factory_Inspection_ID = AFA_Sisal_Factory_Inspection_ID;
    }
