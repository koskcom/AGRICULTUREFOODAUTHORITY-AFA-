...
public class HorticultureNurseryInspectionDetails {

    private LoginRequest loginRequest;

    private String serviceType="QueryNurseryInspectionChecklist";

    private String sentStatus;

    private  String AFA_HC_Nursery_Insp_ID;
    ...
    public HorticultureNurseryInspectionDetails() {
    }

    public HorticultureNurseryInspectionDetails(String documentNumber, String documentDate, String nameOfApplicant, String nurseryLicence) {
    ...
    public String getAFA_HC_Nursery_Insp_ID() {
        return AFA_HC_Nursery_Insp_ID;
    }

    public void setAFA_HC_Nursery_Insp_ID(String AFA_HC_Nursery_Insp_ID) {
        this.AFA_HC_Nursery_Insp_ID = AFA_HC_Nursery_Insp_ID;
    }
