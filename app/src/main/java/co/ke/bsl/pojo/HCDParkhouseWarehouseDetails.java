...
public class HCDParkhouseWarehouseDetails implements java.io.Serializable  {
    ...
    private String AFA_HC_Packhouse_Insp_ID;
    ...
    public HCDParkhouseWarehouseDetails() {
    }

    public HCDParkhouseWarehouseDetails(String documentNumber, String documentDate, String nameOfApplicant, String exportLicence) {
    ...
    public String getAFA_HC_Packhouse_Insp_ID() {
        return AFA_HC_Packhouse_Insp_ID;
    }

    public void setAFA_HC_Packhouse_Insp_ID(String AFA_HC_Packhouse_Insp_ID) {
        this.AFA_HC_Packhouse_Insp_ID = AFA_HC_Packhouse_Insp_ID;
    }
