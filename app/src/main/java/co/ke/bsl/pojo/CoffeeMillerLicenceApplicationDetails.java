...
public class CoffeeMillerLicenceApplicationDetails implements Serializable {


    private LoginRequest loginRequest;

    private String serviceType="QueryCoffeeMillerLicenseApplication";

    private String sentStatus;

    private  String AFA_CD_Millerrchecklist_ID;
    ...
    public CoffeeMillerLicenceApplicationDetails() {
    }

    public CoffeeMillerLicenceApplicationDetails(String documentNumber, String documentDate, String applicantName, String licenceNumber) {
    ...
    public String getAFA_CD_Millerrchecklist_ID() {
        return AFA_CD_Millerrchecklist_ID;
    }

    public void setAFA_CD_Millerrchecklist_ID(String AFA_CD_Millerrchecklist_ID) {
        this.AFA_CD_Millerrchecklist_ID = AFA_CD_Millerrchecklist_ID;
    }
