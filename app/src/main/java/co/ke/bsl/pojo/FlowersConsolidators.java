...
public class FlowersConsolidators implements java.io.Serializable {
    private LoginRequest loginRequest;

    private String serviceType="QueryCoffeeCommericalMarketingAgent";

    private String sentStatus;

    private  String afa_flower_Consolidators_Checklist_id;
    ...
    public FlowersConsolidators() {
    }

    public FlowersConsolidators(String document_number, String document_date, String name_of_applicant, String export_licence, String postal_address, String email, String telephone) {
    ...
    public String getAfa_flower_Consolidators_Checklist_id() {
        return afa_flower_Consolidators_Checklist_id;
    }

    public void setAfa_flower_Consolidators_Checklist_id(String afa_flower_Consolidators_Checklist_id) {
        this.afa_flower_Consolidators_Checklist_id = afa_flower_Consolidators_Checklist_id;
    }
