...
public class TeaBuyerImporterExporterDetails implements Serializable {

    private LoginRequest loginRequest;

    private String serviceType="QueryTeaBuyerImporterExporter";
    ...
    public TeaBuyerImporterExporterDetails() {
    }

    public TeaBuyerImporterExporterDetails(String documentNumber, String documentDate,  String applicantName, String licenseNumber) {
