...
public class FruitsAndVegetablesExporters implements Serializable {


    private LoginRequest loginRequest;

    private String serviceType = "QueryFruitsAndVegetablesExportersInspection";

    private String aFA_HCD_Fruits_Vegetables_Exporterse_ID;
    ...
    public FruitsAndVegetablesExporters() {
    }

    public FruitsAndVegetablesExporters(String documentNumber, String documentDate, String nameOfApplicant, String telephone, String email, String postaladdress, String exportLicence) {
    ...
    public String getaFA_HCD_Fruits_Vegetables_Exporterse_ID() {
        return aFA_HCD_Fruits_Vegetables_Exporterse_ID;
    }

    public void setaFA_HCD_Fruits_Vegetables_Exporterse_ID(String aFA_HCD_Fruits_Vegetables_Exporterse_ID) {
        this.aFA_HCD_Fruits_Vegetables_Exporterse_ID = aFA_HCD_Fruits_Vegetables_Exporterse_ID;
    }
