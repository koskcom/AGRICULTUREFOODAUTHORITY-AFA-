...
public class CottonGinneryInspection implements Serializable {

    private LoginRequest loginRequest;

    private String serviceType = "QueryCottonGinneryInspection";

    private String sentStatus;

    private String AFA_Cotton_Ginnery_Inspection_ID;
    ...
    public CottonGinneryInspection(String documentNumber, String documentDate, String nameOfApplicant, String ginningLicence) {
    ...
    public CottonGinneryInspection() {
    }
    ...
    public String getAFA_Cotton_Ginnery_Inspection_ID() {
        return AFA_Cotton_Ginnery_Inspection_ID;
    }

    public void setAFA_Cotton_Ginnery_Inspection_ID(String AFA_Cotton_Ginnery_Inspection_ID) {
        this.AFA_Cotton_Ginnery_Inspection_ID = AFA_Cotton_Ginnery_Inspection_ID;
    }
