...
public class FoodWareHouseInspection  implements Serializable {
    private String serverRecordID;
    private String sentStatus;
    private LoginRequest loginRequest;
    private String serviceType="QueryFoodWarehouse";
    private String AFA_FD_FOOD_WAREHOUSE_Inspection_ID;
    ...
    public FoodWareHouseInspection(String documentNumber, String documentDate, String nameOfApplicant, String foodWarehouselicence) {
    ...
    public FoodWareHouseInspection() {
    }
    ...
    public String getAFA_FD_FOOD_WAREHOUSE_Inspection_ID() {
        return AFA_FD_FOOD_WAREHOUSE_Inspection_ID;
    }

    public void setAFA_FD_FOOD_WAREHOUSE_Inspection_ID(String AFA_FD_FOOD_WAREHOUSE_Inspection_ID) {
        this.AFA_FD_FOOD_WAREHOUSE_Inspection_ID = AFA_FD_FOOD_WAREHOUSE_Inspection_ID;
    }
