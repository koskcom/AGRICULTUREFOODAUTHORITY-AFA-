...
public class HorticultureCropExportLicenceFarmInspectionDetails implements Serializable {

    private LoginRequest loginRequest;

    private String serviceType="QueryHorticultureCropExportLicenceFarmInspectionDetails";

    private String sentStatus;

    private  String AFA_HC_Export_Farm_Insp_ID;
    ...
    private String horticultureCropExportLicenceFarmInspectionID;

    public HorticultureCropExportLicenceFarmInspectionDetails() {
    }

    public HorticultureCropExportLicenceFarmInspectionDetails(String documentNumber, String nameOfApplicant, String countyId, String documentDate, String isExporterOwnFarm, String isContractedSources, String farmName, String farmerName, String farmerIdNumber, String farmerTelephone, String farmerEmail, String farmerCounty, String farmerLocation, String intendedCrop, String acreageUnderCrop) {
    ...
    public String getAFA_HC_Export_Farm_Insp_ID() {
        return AFA_HC_Export_Farm_Insp_ID;
    }

    public void setAFA_HC_Export_Farm_Insp_ID(String AFA_HC_Export_Farm_Insp_ID) {
        this.AFA_HC_Export_Farm_Insp_ID = AFA_HC_Export_Farm_Insp_ID;
    }
    ...
    public String getHorticultureCropExportLicenceFarmInspectionID() {
        return horticultureCropExportLicenceFarmInspectionID;
    }

    public void setHorticultureCropExportLicenceFarmInspectionID(String horticultureCropExportLicenceFarmInspectionID) {
