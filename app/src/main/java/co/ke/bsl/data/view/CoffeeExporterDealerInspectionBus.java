...
public class CoffeeExporterDealerInspectionBus {

    private static CoffeeExporterDealerInspectionBus single_instance = null;

    private CoffeeExporterDealerInspectionBus() {
    }

    public static CoffeeExporterDealerInspectionBus getInstance() {
        if (single_instance == null)
            single_instance = new CoffeeExporterDealerInspectionBus();

        return single_instance;
    }

    public static CoffeeExporterDealerInspectionBus getSingle_instance() {
        return single_instance;
    }

    public static void setSingle_instance(CoffeeExporterDealerInspectionBus single_instance) {
        CoffeeExporterDealerInspectionBus.single_instance = single_instance;
    }
