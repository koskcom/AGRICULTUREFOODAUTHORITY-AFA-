...
public class FCDSisalFactoryInspectionBus {
    private static FCDSisalFactoryInspectionBus single_instance = null;

    private FCDSisalFactoryInspectionBus() {
    }

    public static FCDSisalFactoryInspectionBus getInstance() {
        if (single_instance == null)
            single_instance = new FCDSisalFactoryInspectionBus();

        return single_instance;
    }

    public static FCDSisalFactoryInspectionBus getSingle_instance() {
        return single_instance;
    }

    public static void setSingle_instance(FCDSisalFactoryInspectionBus single_instance) {
        FCDSisalFactoryInspectionBus.single_instance = single_instance;
    }
