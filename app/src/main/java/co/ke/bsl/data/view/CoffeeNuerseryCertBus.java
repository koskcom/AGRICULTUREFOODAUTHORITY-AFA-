...
public class CoffeeNuerseryCertBus
{
    private static CoffeeNuerseryCertBus single_instance = null;

    private CoffeeNuerseryCertBus() {
    }

    public static CoffeeNuerseryCertBus getInstance() {
        if (single_instance == null)
            single_instance = new CoffeeNuerseryCertBus();

        return single_instance;
    }

    public static CoffeeNuerseryCertBus getSingle_instance() {
        return single_instance;
    }

    public static void setSingle_instance(CoffeeNuerseryCertBus single_instance) {
        CoffeeNuerseryCertBus.single_instance = single_instance;
    }
