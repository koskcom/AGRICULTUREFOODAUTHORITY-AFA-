...
@Entity
public class FruitsVegetablesExportersDeskVetting {

    @PrimaryKey(autoGenerate = true)
    @NonNull
    private int fruitsVegetablesExportersDeskVetting_id;
    ...
    public FruitsVegetablesExportersDeskVetting(int fruitsVegetablesExportersDeskVetting_id, String documentNumber, String documentDate, String nameOfApplicant, String telephone, String email, String postaladdress, String exportLicence, String localID, String isCertificationtoKsh1758, String certificationtoKsh1758Award, String certificationtoKsh1758Timeline, String certificationtoKsh1758Remarks, String isOtherRecognizedstandards, String otherRecognizedstandardsAward, String otherRecognizedstandardsTimeline, String otherRecognizedstandardsremarks, String isEvidenceofRegonNaionalTraceability, String evidenceofRegonNaionalTraceabilityAward, String evidenceofRegonNaionalTraceabilityTimeline, String evidenceofRegonNaionalTraceabilityRemarks, String isEvidenceofRegSingleWindow, String evidenceofRegSingleWindowAward, String evidenceofRegSingleWindowTimeline, String evidenceofRegSingleWindowRemarks, String isCopyOfHcdexportLicence, String copyOfHcdexportLicenceAward, String copyOfHcdexportLicenceTimeine, String copyOfHcdexportLicenceRemarks, String isTraceablitylistOfTheCompany, String traceablitylistOfTheCompanyAward, String traceablitylistOfTheCompanyTimeline, String traceablitylistOfTheCompanyReamrks, String isDeclareMarketingAgents, String declareMarketingAgentsAward, String declareMarketingAgentsTimeline, String declareMarketingAgentsRemarks, String isEvidenceOfhcdRegistered, String evidenceOfhcdRegisteredAward, String evidenceOfhcdRegisteredTimeline, String evidenceOfhcdRegisteredRemarks, String isSystempoliceAndProcedure, String systemPoliceAndProcedureAward, String systemPoliceAndProcedureTimeline, String systemPoliceAndProcedureRemarks, String isEvidenceofAtendanceOfAnnualTraining, String evidenceofAtendanceOfAnnualTrainingAward, String evidenceofAtendanceOfAnnualTrainingTimeline, String evidenceofAtendanceOfAnnualTrainingRemarks, String isAnnualTrainingmatrixSchedule, String annualTrainingmatrixScheduleAward, String annualTrainingmatrixScheduleTimeline, String annualTrainingmatrixScheduleRemarks, String isPestDiseaseControlprocedures, String pestDiseaseControlproceduresAward, String pestDiseaseControlproceduresTimeline, String pestDiseaseControlproceduresRemarks, String isClaimsonNonPayment, String claimsonNonPaymentAward, String claimsonNonPaymentTimeline, String claimsonNonPaymentRemarks, String officerrecommendation, String officerrecommendation_remark, boolean is_synced, String remote_id) {
        this.fruitsVegetablesExportersDeskVetting_id = fruitsVegetablesExportersDeskVetting_id;
    ...
    public int getFruitsVegetablesExportersDeskVetting_id() {
        return fruitsVegetablesExportersDeskVetting_id;
    }

    public void setFruitsVegetablesExportersDeskVetting_id(int fruitsVegetablesExportersDeskVetting_id) {
        this.fruitsVegetablesExportersDeskVetting_id = fruitsVegetablesExportersDeskVetting_id;
    }
