...
public class PyrethrumInspectionBus {

    private static PyrethrumInspectionBus single_instance = null;

    private PyrethrumInspectionBus() {
    }

    public static PyrethrumInspectionBus getInstance() {
        if (single_instance == null)
            single_instance = new PyrethrumInspectionBus();

        return single_instance;
    }

    public static PyrethrumInspectionBus getSingle_instance() {
        return single_instance;
    }

    public static void setSingle_instance(PyrethrumInspectionBus single_instance) {
        PyrethrumInspectionBus.single_instance = single_instance;
    }
    ...
    private String adequate_knowledge;
    ...
    public String getAdequate_knowledge() {
        return adequate_knowledge;
    }

    public void setAdequate_knowledge(String adequate_knowledge) {
        this.adequate_knowledge = adequate_knowledge;
    }
