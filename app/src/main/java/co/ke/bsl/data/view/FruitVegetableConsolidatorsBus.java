...
public class FruitVegetableConsolidatorsBus {


    private static FruitVegetableConsolidatorsBus single_instance = null;

    private FruitVegetableConsolidatorsBus() {
    }

    public static FruitVegetableConsolidatorsBus getInstance() {
        if (single_instance == null)
            single_instance = new FruitVegetableConsolidatorsBus();

        return single_instance;
    }

    public static FruitVegetableConsolidatorsBus getSingle_instance() {
        return single_instance;
    }

    public static void setSingle_instance(FruitVegetableConsolidatorsBus single_instance) {
        FruitVegetableConsolidatorsBus.single_instance = single_instance;
    }
