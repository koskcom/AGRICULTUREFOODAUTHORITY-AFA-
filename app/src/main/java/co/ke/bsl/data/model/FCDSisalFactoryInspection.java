...
@Entity
public class FCDSisalFactoryInspection {

    @PrimaryKey(autoGenerate = true)
    @NonNull
    private int hcd_Sisal_Factory_Inspection_id;
    ...
    public int getHcd_Sisal_Factory_Inspection_id() {
        return hcd_Sisal_Factory_Inspection_id;
    }

    public void setHcd_Sisal_Factory_Inspection_id(int hcd_Sisal_Factory_Inspection_id) {
        this.hcd_Sisal_Factory_Inspection_id = hcd_Sisal_Factory_Inspection_id;
    }
