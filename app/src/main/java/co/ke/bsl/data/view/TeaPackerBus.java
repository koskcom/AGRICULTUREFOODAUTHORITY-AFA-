...
public class TeaPackerBus {
    private static TeaPackerBus single_instance = null;

    private TeaPackerBus() {
    }

    public static TeaPackerBus getInstance() {
        if (single_instance == null)
            single_instance = new TeaPackerBus();

        return single_instance;
    }

    public static TeaPackerBus getSingle_instance() {
        return single_instance;
    }

    public static void setSingle_instance(TeaPackerBus single_instance) {
        TeaPackerBus.single_instance = single_instance;
    }
