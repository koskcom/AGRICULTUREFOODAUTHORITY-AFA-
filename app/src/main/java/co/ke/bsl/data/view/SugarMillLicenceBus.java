...
public class SugarMillLicenceBus {
    private static SugarMillLicenceBus single_instance = null;

    private SugarMillLicenceBus() {
    }

    public static SugarMillLicenceBus getInstance() {
        if (single_instance == null)
            single_instance = new SugarMillLicenceBus();

        return single_instance;
    }

    public static SugarMillLicenceBus getSingle_instance() {
        return single_instance;
    }

    public static void setSingle_instance(SugarMillLicenceBus single_instance) {
        SugarMillLicenceBus.single_instance = single_instance;
    }
