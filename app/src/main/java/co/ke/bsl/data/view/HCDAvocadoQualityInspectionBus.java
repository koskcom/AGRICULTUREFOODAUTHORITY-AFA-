...
public class HCDAvocadoQualityInspectionBus {

    private static HCDAvocadoQualityInspectionBus single_instance = null;

    private HCDAvocadoQualityInspectionBus() {
    }

    public static HCDAvocadoQualityInspectionBus getInstance() {
        if (single_instance == null)
            single_instance = new HCDAvocadoQualityInspectionBus();

        return single_instance;
    }

    public static HCDAvocadoQualityInspectionBus getSingle_instance() {
        return single_instance;
    }

    public static void setSingle_instance(HCDAvocadoQualityInspectionBus single_instance) {
        HCDAvocadoQualityInspectionBus.single_instance = single_instance;
    }

    private String AFA_HC_Avocadochecklist_ID;
    ...
    private String stalkPressenceRemarks, isWoundsdamage,woundsDamageRemarks;
    ...
    public String getAFA_HC_Avocadochecklist_ID() {
        return AFA_HC_Avocadochecklist_ID;
    }

    public void setAFA_HC_Avocadochecklist_ID(String AFA_HC_Avocadochecklist_ID) {
        this.AFA_HC_Avocadochecklist_ID = AFA_HC_Avocadochecklist_ID;
    }
