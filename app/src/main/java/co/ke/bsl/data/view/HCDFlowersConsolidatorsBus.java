...
public class HCDFlowersConsolidatorsBus {
    private static HCDFlowersConsolidatorsBus single_instance = null;

    private HCDFlowersConsolidatorsBus() {
    }

    public static HCDFlowersConsolidatorsBus getInstance() {
        if (single_instance == null)
            single_instance = new HCDFlowersConsolidatorsBus();

        return single_instance;
    }

    public static HCDFlowersConsolidatorsBus getSingle_instance() {
        return single_instance;
    }

    public static void setSingle_instance(HCDFlowersConsolidatorsBus single_instance) {
        HCDFlowersConsolidatorsBus.single_instance = single_instance;
    }
