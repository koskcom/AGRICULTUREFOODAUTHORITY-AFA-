...
@Entity
public class PyrethrumInspection {

    @PrimaryKey(autoGenerate = true)
    @NonNull
    private int pyrethrum_inspection_id;
    ...
    public PyrethrumInspection(int pyrethrum_inspection_id, String document_number, String document_date, String name_of_applicant, String certificate_number, String title_deed, String title_deed_evidence, String title_deed_remarks, String total_acreage, String total_acreage_evidence, String total_acreage_remarks, String acreage_available, String acreage_available_evidence, String acreage_available_remarks, String suitability_of_the_land, String suitability_of_the_land_evidence, String suitability_of_the_land_remarks, String reliable_supply_clean_water, String reliable_supply_clean_water_evidence, String reliable_supply_clean_water_remarks, String accessibility_of_nursery_site, String accessibility_of_nursery_site_evidence, String accessibility_of_nursery_site_remarks, String clearance_letter, String clearance_letter_evidence, String clearance_letter_remarks, String demonstrate_adequate_knowledge, String demonstrate_adequate_knowledge_evidence, String demonstrate_adequate_knowledge_remarks, String age_of_an_existing_crop, String age_of_an_existing_crop_date_planted, String age_of_an_existing_crop_remarks, String source_of_planting_materials, String source_of_planting_materials_evidence, String source_of_planting_materials_remarks, String phenotypic_characteristics, String phenotypic_characteristics_evidence, String phenotypic_characteristics_remarks, String disease_incidences, String disease_incidences_remarks, String pest_incidences, String pest_incidences_remarks, String field_hygiene_conditions, String field_hygiene_conditions_evidence, String field_hygiene_conditions_remarks, String target_market, String target_market_evidence, String target_market_remarks, String inspection_by_kephis, String inspection_by_kephis_evidence, String inspection_by_kephis_remarks, String recommendations, String localID, String officerrecommendation, String officerrecommendation_remark, boolean is_synced, String remote_id) {
        this.pyrethrum_inspection_id = pyrethrum_inspection_id;
    ...
    public int getPyrethrum_inspection_id() {
        return pyrethrum_inspection_id;
    }

    public void setPyrethrum_inspection_id(int pyrethrum_inspection_id) {
        this.pyrethrum_inspection_id = pyrethrum_inspection_id;
    }
