...
public class HCDParkhouseWarehouseBus {
    private static HCDParkhouseWarehouseBus single_instance = null;

    private HCDParkhouseWarehouseBus() {
    }

    public static HCDParkhouseWarehouseBus getInstance() {
        if (single_instance == null)
            single_instance = new HCDParkhouseWarehouseBus();

        return single_instance;
    }

    public static HCDParkhouseWarehouseBus getSingle_instance() {
        return single_instance;
    }

    public static void setSingle_instance(HCDParkhouseWarehouseBus single_instance) {
        HCDParkhouseWarehouseBus.single_instance = single_instance;
    }
